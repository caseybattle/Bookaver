  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-stone-500 dark:text-stone-400 mt-1">Your usage this month on the <span className="text-amber-600 dark:text-amber-400 capitalize">{plan}</span> plan</p>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        <div className="bg-stone-50 dark:bg-stone-900 border border-stone-200 dark:border-stone-800 rounded-xl p-5 space-y-3">
          ...
          <p className="text-xs text-stone-500 dark:text-stone-400">of {limits.books === Infinity ? "unlimited" : limits.books} allowed</p>
        ...
        <div className="bg-stone-50 dark:bg-stone-900 border border-stone-200 dark:border-stone-800 rounded-xl p-5 space-y-3">
          ...
          <p className="text-xs text-stone-500 dark:text-stone-400">of {limits.minutesPerMonth === Infinity ? "unlimited" : limits.minutesPerMonth} this month</p>
          <div className="h-1.5 bg-stone-200 dark:bg-stone-800 rounded-full overflow-hidden">
            <div
              className="h-full bg-amber-500 rounded-full"
        ...
        <div className="bg-stone-50 dark:bg-stone-900 border border-stone-200 dark:border-stone-800 rounded-xl p-5 space-y-3">
          ...
          <p className="text-xs text-stone-500 dark:text-stone-400">{sessions.length} voice sessions this month</p>
        </div>
      </div>
    </div>
  );
